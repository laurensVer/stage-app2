  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Cell tracking", tabName = "cell tracking", icon = icon("clock"),
               ...
               menuSubItem("Plots of the highlight numbers", tabName = "rotated"),
               menuSubItem("Plots stomata tracking", tabName = "test"),
               menuSubItem("Plots PC tracking", tabName = "PC")
      ),
      ...
      tabItem(tabName = "test",
              mainPanel(
                div(style = "overflow-x: auto; white-space: nowrap; width: 150%;",
                    ...
                    div(style = "display: inline-block; width: 33%;", plotOutput("BAM5"))
                ),
                div(style = "overflow-x: auto; white-space: nowrap; width: 150%;",
  ...
  tracking1 <- reactive({
    ...
    for (j in 1:length(V_D3$area_D3)) {
      for (i in 1:length(V_D2$area_D2)) {
        ar <- (V_D3$area_D3[j] / V_D2$area_D2[i]) / av_area_inc
